...
def run_named_job(job_name: str, config_name: str, overrides: list[str] | None = None) -> Any:
    """Start a run of a discovered job: resolve its class, load config, and execute it."""
